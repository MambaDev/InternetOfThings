...
local function trilateration_test()
  local x,y = trilateration(-136, 4, 90.8019823572, 113, 41, 173.818871242, 98, -43, 148.492424049)

  if string.format("%.2f", x) == "-49.00" and string.format("%.2f", y) == "-22.00" then
    print("trilateration_test: PASS")
  else
    print("trilateration_test: FAILED", x, y)
  end
end
